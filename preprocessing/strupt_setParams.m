function pars = strupt_setParams()
% get windowed power for semantic span
pars.froot = '/Volumes/FRNU_EXT/memoryStrupt_data/raw/';
pars.eegRootDir = '/Volumes/FRNU_EXT/memoryStrupt_data/raw/';
pars.msbuffer = 0;
pars.msmirror = 500;
...
pars.dirWriteOut = '/Volumes/FRNU_EXT/memoryStrupt_data/power/monopolar_windows/';
pars.f_name = 'ecog/';
