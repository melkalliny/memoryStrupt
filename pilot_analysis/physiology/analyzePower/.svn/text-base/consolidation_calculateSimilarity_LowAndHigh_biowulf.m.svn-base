...
%                     idealized_context_matrix = (idealized_context_matrix-tempmean) / tempstd;
        ...
        save(sprintf('/data/elkallinymm/consolidationProject/outputs/windows/%s/dataSubject_%s_%s.mat',subjectNames{n},stringEvent,num2str(windowType)),'dataSubject','corrConsistencyVsBehavior')
