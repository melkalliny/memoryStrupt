function [out] = consolidation_preprocessLowAndHigh_allTime()
...
for n = [1:6]
    ...
    load(sprintf('/Volumes/FRNU_SVN/consolidation_SVN/consolidationProject/intermediates/power_LowAndHigh_monopolar_window%d/%s/powDir/allPowData.mat',windowSize,subjectNames{n}))
    ...
    load(sprintf('/Volumes/FRNU_SVN/consolidation_SVN/consolidationProject/intermediates/power_LowAndHigh_monopolar_window%d/%s/powDir/events.mat',windowSize,subjectNames{n}))
   ...
   if ~exist(sprintf('/Volumes/FRNU_SVN/consolidation_SVN/consolidationProject/intermediates/processedPower_LowAndHigh_monopolar_window%d/%s/',windowSize,subjectNames{n})) %#ok<EXIST>
       mkdir(sprintf('/Volumes/FRNU_SVN/consolidation_SVN/consolidationProject/intermediates/processedPower_LowAndHigh_monopolar_window%d/%s/',windowSize,subjectNames{n})); 
   end
   
   save(sprintf('/Volumes/FRNU_SVN/consolidation_SVN/consolidationProject/intermediates/processedPower_LowAndHigh_monopolar_window%d/%s/allPowData.mat',windowSize,subjectNames{n}),'processed_power','evsOfInterest','-v7.3')
